define([
   ...
   // esriConfig.defaults.io.proxyUrl = 'http://localhost/cmv-app/proxy/PHP/proxy.php';
    ...
    urlUtils.addProxyRule({
        ...
        proxyUrl: 'http://localhost/cmv-app/proxy/PHP/proxy.php'
    });

    // url to your geometry server.
    esriConfig.defaults.geometryService = new GeometryService('http://122.160.40.75:6080/ArcGIS/rest/services/Geometry/GeometryServer');
    ...
    return {
        ...
        */
        ...
        operationalLayers: [/* {
            type: 'feature',
            url: 'http://122.160.40.75:6080/arcgis/rest/services/eams/embankment/FeatureServer/5',
            title: i18n.viewer.operationalLayers.embankment_points,
            options: {
                id: 'embankment_points',
                opacity: 1.0,
                visible: true,
                outFields: ['*'],
                mode: 0
            ...
            type: 'feature',
            url: 'http://122.160.40.75:6080/arcgis/rest/services/eams/embankment/FeatureServer/1',
            title: i18n.viewer.operationalLayers.senstive_zone,
            options: {
                id: 'senstive_zone',
                opacity: 1.0,
                visible: true,
            ...
            type: 'dynamic',
            url: 'http://122.160.40.75:6080/arcgis/rest/services/eams/embankment/MapServer',
            title: i18n.viewer.operationalLayers.embankment_points,
            options: {
                id: 'embankment_points',
                opacity: 1.0,
		...
		{
            type: 'dynamic',
            url: 'http://122.160.40.75:6080/arcgis/rest/services/eams/rapti_attributes/MapServer',
            title: i18n.viewer.operationalLayers.rapti_attributes,
            options: {
                id: 'rapti_attributes',
                opacity: 1.0,
                visible: true,
		...
		{
            type: 'dynamic',
            url: 'http://122.160.40.75:6080/arcgis/rest/services/eams/embankments_centerline/MapServer',
            title: i18n.viewer.operationalLayers.ceterline_rivers,
            options: {
                id: 'ceterline_rivers',
                opacity: 1.0,
                visible: true,
       ...
       // } 
        ...
        widgets: {
            ...
            help: {
                ...
                paneOptions: {
                    draggable: false,
                    html: '<a href="http://geoitanalytics.com"><i class="fa fa-fw fa-info-circle"></i>link</a>'.replace('link', i18n.viewer.widgets.help),
                    domTarget: 'helpDijit',
